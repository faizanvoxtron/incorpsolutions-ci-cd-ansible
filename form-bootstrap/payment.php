...
// $api_token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyIjoiQnJhbmQiLCJuYW1lIjoiQnJhbmQiLCJBUElfVElNRSI6MTcyOTI4ODk5OX0.DGjmop4J-MuBQBnBXk_hLVrLzPhUSC40nF6MH91WL_8";
// $api_base_url = 'https://dashboard.theincorpsolutions.com/api/';
$items = [
    [
...
if ($invoice_info->status) {
    $invoice_url = "https://dashboard.theincorpsolutions.com/invoice/" . $invoice_info->invoice->id . "/" . $invoice_info->invoice->hash;
    // echo json_encode([
    //     'status' => true,
    //     'message' => "Success",
    //     'url' => $invoice_url,
    ...
    // CATCH ERRORS
    $payment_page_url = "https://theincorpsolutions.com/checkout.php";
    // echo json_encode([
    //     'status' => false,
...
{
    $url = "https://dashboard.theincorpsolutions.com/api/leads/" . $lead_id;
    $ch = curl_init();
...
{
    $url = "https://dashboard.theincorpsolutions.com/api/customers";
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, $url);
...
{
    $url = "https://dashboard.theincorpsolutions.com/api/contacts";
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, $url);
    curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, false);
    curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
...
{
    $url = "https://dashboard.theincorpsolutions.com/api/invoices";
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, $url);
    curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, false);
    curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
