<!-- Header Include -->
<?php
$pageTitle = "Terms and Conditions | Incorp Solutions";
$pageDescription = "";
...
<section class="privacy-terms">
    <div class="container">
        <h2 class="inner-heading">Terms and Conditions</h2>
        <div class="content">
            <p class="bold">By continuing forward with the Incorp Solutions website (the “Website”), you agree to all of the following terms and conditions as a binding agreement between you and theincorpsolutions.com and Incorp Solutions, LLC (referred to as “we”, “us” or “our”). This Agreement also assimilates our Privacy Policy as is set forth at an extensive length herein. If you do not see yourself agreeing to these terms and conditions, kindly refrain from using the Website</p>
            ...
            <h2 class="sub-heading">YOUR ACCOUNT PROFILE</h2>
            ...
            <h2 class="sub-heading">YOUR CONDUCT</h2>
            ...
            <h2 class="sub-heading">LINKS TO OTHER SITES</h2>
            ...
            <h2 class="sub-heading">DISPLAY OF DATA AND SEARCH</h2>
            ...
            <h2 class="sub-heading"> CALENDAR REMINDERS</h2>
            ...
            <h2 class="sub-heading">CREATION OF FORMS AND DISCLAIMER</h2>
            ...
            <p>We provide you with a draft of the application for your review. If you do not respond with timeliness, you authorize us to sign your name to the application, file it as provided in the draft, and to collect from you the governmental filing fee of <span class="dollar-symbol-change">$</span>350 per class at that time.</p>

            <h2 class="sub-heading">SEARCH SERVICES</h2>
            ...
            <p>Our Incorp Solutions, LLC federal trademark search reviews the USPTO database and is restricted to direct matches, phonetically similar, similar in terms of translation, or appearance by way of design.</p>

            <p>Our Incorp Solutions, LLC federal, government and common law search reviews the USPTO database, the databases of all 50 states, a business registry and the database of domain names. It is restricted to only direct matches, phonetically similar, similar in terms of translation, or appearance by way of design.</p>

            <p>Our Incorp Solutions, LLC global search reviews the USPTO database, the databases of all 50 states, a business registry, the database of domain names, the World Intellectual Property Organization (“WIPO”) database and the European Community database. It is restricted to direct matches, phonetically similar, or appearance by way of design.</p>

            <h2 class="sub-heading">TRADEMARK MONITORING SERVICES</h2>
            <p>Our trademark monitoring services assess the filing of new applications that are direct matches, phonetically similar, similar in terms of translation, or appearance by way of design to your marks as published in the Official Gazette of the USPTO and Incorp Solutions, LLC.</p>

            <h2 class="sub-heading">DISCLAIMERS OF WARRANTY AND LIMITATIONS OF LIABILITY</h2>
            ...
            <p>THE RIGHT TO OPT OUT OF BINDING ARBITRATION AND CLASS ACTION WAIVER WITHIN 30 DAYS. IF YOU DO NOT WISH TO BE BOUND BY THE BINDING ARBITRATION AND CLASS ACTION WAIVER IN THIS SECTION, YOU ARE REQUIRED TO NOTIFY US IN WRITING WITHIN 30 DAYS OF THE DATE THAT YOU ACCEPT THIS AGREEMENT. YOUR WRITTEN NOTIFICATION MUST BE E-MAILED TO Incorp Solutions, LLC, legal@theincorpsolutions.com WITH THE SUBJECT LINE “OPT-OUT’ AND INCLUDE: (1) YOUR NAME, (2) YOUR ADDRESS, AND (4) A CLEAR STATEMENT THAT YOU DO NOT WISH TO RESOLVE DISPUTES WITH US THROUGH ARBITRATION.</p>

            <p>Any arbitration will be administered by the AAA under its Commercial Arbitration Rules. If the value of the dispute is <span class="dollar-symbol-change">$</span>75,000 or less, its Supplementary Procedures for Consumer-Related Disputes shall also be applicable. On disputes involving <span class="dollar-symbol-change">$</span>75,000 or less, we will punctually reimburse your filing fees and pay the AAA's and arbitrator’s fees and expenses. You agree to start arbitration only in your county of permanent residence or in California, US. We agree to commence arbitration only in your county of residence. You may request a telephonic or in-person hearing by following the AAA rules. In a dispute involving <span class="dollar-symbol-change">$</span>10,000 or less, any hearing will be telephonic unless the arbitrator finds good cause to hold an in-person hearing instead. The arbitrator may award the same damages to you individually as a court could. The arbitrator may award declaratory or injunctive relief only to you individually, and only to the extent required to satisfy your individual claim. Nothing herein restricts Incorp Solutions, LLC from demanding the arbitrator to award Incorp Solutions, LLC all costs of the arbitration including any Administrative Fees paid on your behalf.</p>
            ...
            <h2 class="sub-heading">Intellectual Property</h2>
            ...
            <h2 class="sub-heading">Modifications to the Agreement</h2>
            ...
            <h2 class="sub-heading">Authorization</h2>
            ...
            <h2 class="sub-heading">Refund Policy</h2>
            <p>The Incorp Solutions strives to meet the trademark needs of our customers in a professional, cordial, and effective manner. We want every single customer to be 100% satisfied, so we will work with any customer who has any questions or concerns about their filings. Our customer service team is made up of dedicated and courteous trademark representatives with one goal - to meet each client's needs in a friendly, caring, and efficient manner. If you do not think we have met this goal, let us know and we will be happy to make every effort to resolve the issues to your satisfaction. You can send us an email at <strong>legal@theincorpsolutions.com or call us toll free at +1 (833) 337-0930 .</strong></p>

            <p>If we make any mistakes in your filing, we will do our level best to admit it and make the necessary improvements needed to fix the correction as soon as we can at no additional cost to you. Please note the Incorp Solutions fees and all government levied fees involved in your filing services are non-refundable. The USPTO may experience delays or deny your application without any fault of the Incorp Solutions. These issues are beyond our control and will not be the basis for a refund.</p>

            <p>If you decide that you want a refund, all such requests must be submitted before the initial trademark search clearance report is conducted. Your refund will be issued in the same form that it was received. For example, if the payment to Incorp Solutions, LLC was made by credit card then the refund will be issued to the same credit card used to make the payment. However, if you choose, you may request to receive a credit for future Incorp Solutions, LLC purchases/payments instead of a refund.</p>

            <h2 class="sub-heading">Miscellaneous</h2>
