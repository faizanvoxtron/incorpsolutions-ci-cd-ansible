...
<footer class="footer">
                ...
                <div class="row justify-content-between">
                    <div class="col-md-4">
                        <div class="logo-widget">
                            <a href="/">
                                <img loading="lazy" src="assets/images/logo-white.svg" alt="Incorp Solutions" width="200">
                            </a>
                            <p>At Incorp Solutions, our focus remains on serving our clients and offer them best alongside timesaving &amp; hassle-free solutions that further transforms their productivity.</p>
                        </div>
                    </div>
                    <div class="col-lg-2">
                    ...
                    <div class="col-lg-4">
                        <div class="link-widget">
                            <h5>Contact</h5>
                            <ul>
                                <li><i class="ic-3 fa-solid fa-phone fa-beat"></i><a href="mailto:legal@theincorpsolutions.com" target="_blank">legal@theincorpsolutions.com</a></li>
                                <li><i class="ic-5 fa-solid fa-envelope fa-beat"></i><a href="tel:+18333370930" target="_blank">+1 (833) 337-0930</a></li>
                                <li><i class="ic-5 fa-solid fa-location-dot fa-beat"></i><a href="https://maps.app.goo.gl/ou5EnuPYNkeJ9MULA" target="_blank">26791 Aliso Creek Rd,Aliso Viejo, CA 92656</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="sec-copyright">
        <div class="container">
            <div class="content">
                <p> © Copyright 2024 Incorp Solutions. All Rights Reserved.</p>
            </div>
        </div>
    </div>
</footer>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12 popup-right-col">
                        <a class="navbar-brand" href="/"><img src="assets/images/favicon.png" alt="Incorp Solutions" width="100px"></a>
                        <p>Providing you the perfect solution for your business needs. Let's work together and unlock doors to
                            success.</p>
                        <form class="popupForm" id="popupForm" method="POST" action="form-bootstrap/lead.php" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="selected_service" id="selected_service_field" value="trademark">
                            <div class="row">
                                <div class="col-md-12">
                                    <ul>
                                        <li>
